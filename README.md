...
Pour tester simplement & rapidement, veuillez préférer visiter la démo en ligne : [ohmyfood.abenrejeb.com](https://alibenrejeb.github.io/ohmyfood.github.io/)

Sinon, clonez le projet
```terminal
git clone git@github.com:alibenrejeb/ohmyfood.git
```
